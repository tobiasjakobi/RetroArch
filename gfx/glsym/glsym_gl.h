...
typedef void (APIENTRYP RGLSYMGLENDTRANSFORMFEEDBACKPROC) ();
...
typedef void (APIENTRYP RGLSYMGLENDCONDITIONALRENDERPROC) ();
...
typedef void (APIENTRYP RGLSYMGLPAUSETRANSFORMFEEDBACKPROC) ();
typedef void (APIENTRYP RGLSYMGLRESUMETRANSFORMFEEDBACKPROC) ();
...
typedef void (APIENTRYP RGLSYMGLRELEASESHADERCOMPILERPROC) ();
...
typedef void (APIENTRYP RGLSYMGLPOPDEBUGGROUPPROC) ();
...
typedef GLenum (APIENTRYP RGLSYMGLGETGRAPHICSRESETSTATUSARBPROC) ();
...
typedef GLhandleARB (APIENTRYP RGLSYMGLCREATEPROGRAMOBJECTARBPROC) ();
