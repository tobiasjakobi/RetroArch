...
const menu_ctx_driver_t menu_ctx_rmenu = {
   .set_texture = rmenu_set_texture,
   .render_messagebox = rmenu_render_messagebox,
   .render = rmenu_render,
   .init = rmenu_init,
   .free = rmenu_free,
   .context_reset = rmenu_context_reset,
   .context_destroy = rmenu_context_destroy,
   .input_postprocess = rmenu_input_postprocess,
   .init_core_info = rmenu_init_core_info,
